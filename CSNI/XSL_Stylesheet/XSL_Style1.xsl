<?xml version="1.0" encoding="utf-8"?><!-- DWXMLSource="ResultsReport.xml" -->
...
<div style="background-image:url(../images/BDr_line1.gif); background-repeat:repeat">
  <div class="Bg1">
    ...
    <td class="csiLayout3" ></td>
      ...
      <tr>
        <td class="csiLayout1" ></td>
      <td class="csiLayout2_HD" ><div id="headlinks1"><a href="../index.html" title="Home page of cosmeticsurgerynagpurindia.com" onmouseover="closeall()" onfocus="closeall()">Home</a><a href="../About-CosmetiSurgeryNagpurIndia.html" onmouseover="closeall()" onfocus="closeall()" title="About Cosmetic Surgery Nagpur India health center">About&nbsp;us</a><a href="../comsetic_surgery_in_India.html" onmouseover="closeall()" onfocus="closeall()" title="Cosmetic surgery in Nagpur">Cosmetic&nbsp;surgery&nbsp;in&nbsp;Nagpur</a><a href="../Cosmetic-surgery-treatment-nagpur-India.html" onmouseover="closeall()" onfocus="closeall()" title="Available surgeries and treatments in Nagpur">Treatments</a><a href="../Cosmetic-Surgeons-Nagpur-India.html" onmouseover="closeall()" onfocus="closeall()" title="Meet the doctors of and in Nagpur">Meet&nbsp;the&nbsp;doctors</a><a href="../Patient-Testimonials.html" onmouseover="closeall()" onfocus="closeall()" title="Patient photo and video testimonials">Photo&nbsp;&amp;&nbsp;video&nbsp;testimonials</a><a href="../News.html" onmouseover="closeall()" onfocus="closeall()" title="News and articles">News</a><a href="../enquiry.html" onmouseover="closeall()" onfocus="closeall()" title="Enquiry form">Enquiry</a><a href="../FAQs.html" onmouseover="closeall()" onfocus="closeall()" title="Frequently asked questions">FAQs</a><a href="../Contact-Us.html" onmouseover="closeall()" onfocus="closeall()" title="Contact form">Contact&nbsp;us</a></div></td>
      <td class="csiLayout3" ></td>
    </tr>
      <tr>
        <td class="csiLayout1" ></td>
            ...
            <td valign="top" class="tdauto"><div id="PageContent1"><a name="top" id="top"></a>
              <div class="HDTitle_BG">
                ...
                <table border="0" cellspacing="0" cellpadding="0">
                  ...
                  <xsl:for-each select="mm_report/mm_reportitem">
                    <tr>
                      <td style="padding-right:1.1875em"><xsl:value-of select="mm_displaystr" disable-output-escaping="yes"/></td>
                      <td><xsl:value-of select="mm_description" disable-output-escaping="yes"/></td>
                    </tr>
                    </xsl:for-each>
                  </table>
                <p> </p>
                  ...
                  <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" summary="Cosmeticsurgerynagpurindia.com; menu layout: Table2">
                    <tr>
                      <td class="blocklink1"><div class="RMenu_h">Introduction  to cosmetic surgery</div>
                        ...
                        <div><a href="../Cosmetic-Surgeons-Nagpur-India.html" title="Meet the doctors of and in Nagpur" onmouseover="closeall()" onfocus="closeall()">Meet  the doctors</a></div>
                        <div><a href="../Patient-Testimonials-Before-After.html" title="Patient's before &amp; after surgery snaps" onmouseover="closeall()" onfocus="closeall()">Before &amp; after pictures</a></div>
                        <div><a href="../Resources.html" title="Links and resources" onmouseover="closeall()" onfocus="closeall()">Resources</a></div>
                        <div><a href="../About-CosmetiSurgeryNagpurIndia.html" title="About us" onmouseover="closeall()" onfocus="closeall()">Why   us</a></div>
                        <div><a href="../make_an_appoinment.html" title="Fill appointment form" onmouseover="closeall()" onfocus="closeall()">Make an appointment</a></div>
                        <div><a href="../plan_your_visit.html" title="Plan your visit" onmouseover="closeall()" onfocus="closeall()">Plan your visit</a></div>
                        <div><a href="../Payment_Protocol.html" title="Payment  protocol" onmouseover="closeall()" onfocus="closeall()">Payment  protocol</a></div></td>
                    </tr>
                    </table></td>
                </tr>
                <tr>
      ...
      <tr>
        <td class="csiLayout1" ></td>
      <td class="csiLayout2_2" ><div id="CpyRts">
